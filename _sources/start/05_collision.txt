...
We have taken our double pendulum code and removed the sensors and turned the network it to a simple forward actuation about its connection in space. This simulation hit a ball in the environment into the target blocks.
